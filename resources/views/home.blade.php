...
<div class="grid w-full h-screen grid-cols-1 my-auto xl:gap-14 md:gap-5">
    <div class="flex flex-col md:w-[700px] justify-center col-span-1 text-center lg:text-center mx-auto">
        ...
        <div class="flex flex-col items-center">
            <a href="/admin/login">
                <button class="flex items-center w-[220px] py-4 text-lg font-bold text-center justify-center px-7 bg-purple-blue-500 text-white hover:bg-[#1f2758] hover:text-[#efea2d] focus:ring-4 focus:ring-purple-blue-100 transition duration-300 rounded-xl">Buat Request</button>
            </a>
        </div>
